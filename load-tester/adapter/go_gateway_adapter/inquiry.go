...
func (adapter *Adapter) GetAccountByAccountNumber(ctx context.Context, params *GetAccountByAccountNumberParams) (*GetAccountByAccountNumberResult, error) {
	const op = "go_gateway_adapter.Adapter.GetAccountByAccountNumber"
	...
	response, err := adapter.goGatewayClient.GetAccountByAccountNumber(ctx, request)
	if err != nil {
